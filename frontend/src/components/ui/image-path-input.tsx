        ...
        <div className="absolute z-50 w-full mt-1 bg-white border border-gray-200 rounded-lg shadow-xl max-h-80 flex flex-col animate-in fade-in zoom-in-95 duration-150">
          ...
          {currentPath && (
            <div className="flex items-center gap-1 px-3 py-2 bg-gray-50 border-b text-xs overflow-x-auto">
              <button
                className="flex items-center gap-1 px-2 py-1 hover:bg-white rounded transition-colors whitespace-nowrap has-hover-only"
                onClick={() => navigateTo('')}
              >
              ...
              {breadcrumbs.map((crumb, index) => {
                ...
                return (
                  <div key={path} className="flex items-center gap-1">
                    ...
                    <button
                      className="px-2 py-1 hover:bg-white rounded transition-colors whitespace-nowrap has-hover-only"
                ...
                {subfolders.map(folderPath => {
                  ...
                  return (
                    <button
                      key={folderPath}
                      type="button"
                      className="w-full flex items-center gap-2 px-3 py-2 text-sm hover:bg-green-50 rounded-md transition-colors text-left group has-hover-only"
