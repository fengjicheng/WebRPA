...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/模块数量-473个-brightgreen.svg" alt="模块数量">
...
- **🔧 模块丰富**：473个功能模块，覆盖90%自动化场景
- **🤖 AI 小助手**：内置 AI 助手，可对话式理解需求、自动搭建/排查工作流（OpenAI 兼容协议，支持 OpenAI / 智谱 / Deepseek / Ollama 等）
- **🎨 界面美观**：现代化UI设计，Motion动效灵动，操作流畅，支持Mermaid流程图
- **⚡ 性能强劲**：基于FastAPI + React，响应迅速
- **🔌 易于扩展**：模块化架构，支持自定义开发，支持 MCP 服务器接入
- **📚 文档完善**：31篇详细教学文档，覆盖所有473个模块分类
- **🆓 完全免费**：非商业使用完全免费，开源透明
