...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/模块数量-471个-brightgreen.svg" alt="模块数量">
...
WebRPA 由独立开发者业余时间维护，没有任何商业模式、广告、付费墙，完全免费且开源。
项目能持续更新离不开每一位用户的支持。

**每一位赞助者的名字都会被收录到本节，作为永久的感谢。**

> 赞助方式：打开 WebRPA 启动器，点击右上角"支持作者"按钮，扫码即可赞助。
> 也可以通过 [爱发电主页](https://ifdian.net/a/qypmh) 赞助。
> 赞助后请通过爱发电私信留下你想被收录的昵称（可选 GitHub 用户名/微信昵称等）。
