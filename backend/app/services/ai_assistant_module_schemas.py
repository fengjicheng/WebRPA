...
EXTRA_SCHEMAS: dict = {
    ...
    # SAP
    "sap_login": {
        # 执行器：必填 username/password + (connName 或 connString 二选一)；mandt 默认 800
        "required": ["username", "password"],
        "optional": ["connName", "connString", "mandt", "language", "saveToVariable"],
        "defaults": {"mandt": "800", "language": "ZH", "saveToVariable": "sap_session"},
        "desc": {"connName": "SAP Logon 连接名（与 connString 二选一）", "connString": "连接字符串（与 connName 二选一）",
                 "mandt": "客户端(集团)代码，默认 800", "language": "EN/ZH", "saveToVariable": "会话保存到的变量"},
        "example": {"connName": "S4X", "username": "{u}", "password": "{p}", "mandt": "800"},
        "combo": "",
    },
    "sap_run_tcode": {
        "required": ["tcode"],
        "optional": ["sessionVariable"],
        "defaults": {"sessionVariable": "sap_session"},
        "desc": {"tcode": "事务码如 VA01", "sessionVariable": "SAP 会话变量"},
        "example": {"tcode": "VA01"},
        "combo": "",
    },
    "sap_set_field_value": {
        ...
        "optional": ["sessionVariable"],
        "defaults": {"sessionVariable": "sap_session"},
        "desc": {"elementId": "SAP 元素 ID（如 wnd[0]/usr/ctxtVBAK-AUART）", "value": "要填的值"},
        "example": {"elementId": "wnd[0]/usr/ctxtVBAK-AUART", "value": "OR"},
        "combo": "",
    },
    "sap_get_field_value": {
        "required": ["elementId"],
        "optional": ["saveToVariable", "sessionVariable"],
        "defaults": {"saveToVariable": "sap_value", "sessionVariable": "sap_session"},
        "desc": {"elementId": "SAP 元素 ID", "saveToVariable": "读取值保存到的变量"},
        "example": {"elementId": "wnd[0]/usr/txtVBAK-VBELN"},
        "combo": "",
    },
    "sap_click_button": {
        "required": ["elementId"],
        "optional": ["sessionVariable"],
        "defaults": {"sessionVariable": "sap_session"},
        "desc": {"elementId": "SAP 按钮元素 ID（如 wnd[0]/tbar[0]/btn[8]）"},
        "example": {"elementId": "wnd[0]/tbar[0]/btn[8]"},
        "combo": "",
    },
    "sap_logout": {"required": [], "optional": ["sessionVariable"], "defaults": {"sessionVariable": "sap_session"}, "desc": {}, "example": {}, "combo": ""},
...
ADVANCED_MATH_SCHEMAS: dict = {
    ...
    "math_random_advanced": {
        "required": [],
        "optional": ["type", "min", "max", "mean", "stddev", "lambda", "count", "decimals", "resultVariable"],
        "defaults": {"type": "uniform", "min": "0", "max": "100", "mean": "0", "stddev": "1", "lambda": "1", "count": 1, "decimals": 0, "resultVariable": "random_advanced"},
        "desc": {"type": "分布类型: uniform/normal/exponential", "mean": "正态分布均值 μ", "stddev": "正态分布标准差 σ", "lambda": "指数分布 λ 参数", "decimals": "小数位"},
        "example": {"type": "uniform", "min": "1", "max": "100"},
        "combo": "",
    },
...
EXTRA3_SCHEMAS: dict = {
    ...
    "sap_set_checkbox": {
        ...
        "defaults": {"checked": True},
        "desc": {},
        "example": {"elementId": "BTN-X", "checked": True},
        "combo": "",
    },
    "sap_select_combobox": {
        ...
        "defaults": {},
        "desc": {},
        "example": {"elementId": "CB-1", "key": "OPT_A"},
        "combo": "",
    },
    "sap_send_vkey": {
        "required": ["vkey"],
    ...
    "sap_read_gridview": {
        ...
        "desc": {},
        "example": {"elementId": "GRID-1"},
        "combo": "",
    },
    "sap_export_gridview_excel": {
        "required": ["elementId", "savePath"],
        "optional": ["resultVariable"],
        "defaults": {"resultVariable": "export_path"},
        "desc": {},
        "example": {"elementId": "GRID-1", "savePath": "D:\\\\out.xlsx"},
        "combo": "",
    },
    "sap_set_focus": {
        "required": ["elementId"],
...
FINAL_SCHEMAS: dict = {
    ...
    "sap_select_tab": {
        ...
        "optional": [],
        "defaults": {},
        "desc": {"elementId": "选项卡 ID"},
        "example": {"elementId": "TAB-1"},
        "combo": "",
    },
...
_MULTIMODE_REQUIRED_FIX: dict = {
    ...
    "keyboard_action": {
        # 执行器与配置面板都用 keySequence（不是 keys）——必填字段名对齐，避免误报"必填未填写"
        "required": ["keySequence"],
        "optional": ["targetType", "selector", "pressMode", "holdDuration", "delay"],
        "defaults": {"targetType": "page", "pressMode": "click"},
        "desc": {
            "keySequence": "按键序列，如 Enter / Ctrl+A / Ctrl+Shift+S",
            "targetType": "page(整个页面) / element(指定元素)",
            "selector": "targetType=element 时的元素选择器",
            "pressMode": "click(点击) / hold(长按)",
        },
        "example": {"keySequence": "Ctrl+A", "targetType": "page"},
        "combo": "",
    },
}
...
EXCEL_SCHEMAS_2: dict = {
    ...
    "excel_read_cell": {
        ...
        "optional": ["sheetName", "resultVariable", "readContent"],
        "defaults": {"resultVariable": "cell_value", "readContent": "value"},
        "desc": {"cell": "单元格地址如 A1", "resultVariable": "存储读到的值",
                 "readContent": "读取内容：value 读计算结果（默认）/ formula 读公式本身"},
    ...
    "excel_read_range": {
        ...
        "optional": ["sheetName", "resultVariable", "readContent"],
        "defaults": {"resultVariable": "range_data", "readContent": "value"},
